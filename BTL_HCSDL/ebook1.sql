...
USE EBOOKSTORE;
CREATE TABLE BOOK(
	ISBN		CHAR(13), /*char:constant length; varchar:fixed length*/
...
CREATE TABLE WORK_FOR(
    ...
    PRIMARY KEY (PCODE, AID),
    FOREIGN KEY (PCODE) REFERENCES PUBLISHER(PNAME) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE BOOK
ADD FOREIGN KEY (PUBLISHER_NAME) REFERENCES PUBLISHER(PNAME) ON DELETE CASCADE ON UPDATE CASCADE;
/* Thêm cột PUBLISHER_NAME vào BOOK 
 FOREIGN KEY trong TH publisher đc tạo sau book
*/
...
CREATE TABLE CUSTOMER_SHIPPING_ADDR (
	CID	CHAR(9),
    ADDRESS VARCHAR(100),
...
CREATE TABLE BOOK_TRANSACTION (
    ...
    SHIPPING_ID CHAR(9),
    primary key (PURCHASED_DATE,CID),
    FOREIGN KEY (CID) REFERENCES CUSTOMER(ID) ON DELETE CASCADE ON UPDATE CASCADE,
